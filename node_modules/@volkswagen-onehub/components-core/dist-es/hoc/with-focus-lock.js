 ...
 * ```
 */
export const withFocusLock = (WrappedComponent) => { var _a; return _a = class WithFocusLock extends React.PureComponent {
        constructor() {
            super(...arguments);
        ...
        render() {
            ...
            return (React.createElement(FocusTrap, { returnFocus: true, autoFocus: true },
