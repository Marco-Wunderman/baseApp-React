...
const StyledTextComponent = styled(BaseComponent).withConfig({ displayName: "StyledTextComponent", componentId: "sc-hqqa9q" }) `
	...
	${props => {
    if (props.textAlign && isBreakpointConfig(props.textAlign)) {
...
export function Text(props) {
    ...
    if (appearance && appearance.match(/textTypes/)) {
        warn('`textTypes` are deprecated, because they use the old breakpoints. Use `textAppearances` instead.');
    }
