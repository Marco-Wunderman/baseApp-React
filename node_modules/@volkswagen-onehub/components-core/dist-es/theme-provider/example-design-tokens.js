...
const generateBreakpoints = (fontSize, fn) => Object.values(Breakpoints).reduce((acc, breakpoint) => {
    if (fontSize[breakpoint]) {
        return [
            ...acc,
            {
                breakpoint: breakpoint === Breakpoints.default ? breakpoint : `${breakpoint}px`,
...
export const designTokens = {
    ...
    textTypes: {
        ...
        copy100: generateFontType(DesignTokenFontSizes.size100, FontStyles.Copy),
        copy150: generateFontType(DesignTokenFontSizes.size150, FontStyles.Copy),
        copy200: generateFontType(DesignTokenFontSizes.size200, FontStyles.Copy),
        copy250: generateFontType(DesignTokenFontSizes.size250, FontStyles.Copy),
        copy300: generateFontType(DesignTokenFontSizes.size300, FontStyles.Copy),
        headline200: generateFontType(DesignTokenFontSizes.size200, FontStyles.Headline),
        headline250: generateFontType(DesignTokenFontSizes.size250, FontStyles.Headline),
        headline300: generateFontType(DesignTokenFontSizes.size300, FontStyles.Headline),
        headline350: generateFontType(DesignTokenFontSizes.size350, FontStyles.Headline),
        headline400: generateFontType(DesignTokenFontSizes.size400, FontStyles.Headline),
        headline450: generateFontType(DesignTokenFontSizes.size450, FontStyles.Headline),
        headline500: generateFontType(DesignTokenFontSizes.size500, FontStyles.Headline),
        headline550: generateFontType(DesignTokenFontSizes.size550, FontStyles.Headline),
        headline600: generateFontType(DesignTokenFontSizes.size600, FontStyles.Headline),
        label100: generateFontType(DesignTokenFontSizes.size100, FontStyles.Label),
        label150: generateFontType(DesignTokenFontSizes.size150, FontStyles.Label),
        label200: generateFontType(DesignTokenFontSizes.size200, FontStyles.Label),
        label250: generateFontType(DesignTokenFontSizes.size250, FontStyles.Label),
        label300: generateFontType(DesignTokenFontSizes.size300, FontStyles.Label)
    },
    textAppearances: {
