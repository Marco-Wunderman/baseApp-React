...
export class ButtonPrevious extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const icon = direction === 'ltr' ? (React.createElement(ArrowLeft, { variant: size === 'small' ? 'small' : 'default' })) : (React.createElement(ArrowRight, { variant: size === 'small' ? 'small' : 'default' }));
