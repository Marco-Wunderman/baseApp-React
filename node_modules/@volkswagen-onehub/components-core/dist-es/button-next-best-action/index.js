...
const keyframesInitializing = keyframes `
	0% {
		opacity: 0;
	}
...
`;
const StyledOverflowWrapper = styled.div.withConfig({ displayName: "StyledOverflowWrapper", componentId: "sc-1pt9oer" }) `
...
`;
const StyledTextWrapper = styled.div.withConfig({ displayName: "StyledTextWrapper", componentId: "sc-bublms" }) `
	...
	align-items: center;
`;
const StyledIconWrapper = styled.div.withConfig({ displayName: "StyledIconWrapper", componentId: "sc-1rs67cr" }) `
	height: ${props => parseInt(props.theme.size.static350, 10) +
    parseInt(props.theme.size.static300, 10) *
        2}px; /* icon size plus top and bottom borders */
	...
	transition: border-color
		${props => `${props.theme.animation.duration.nba} ${props.theme.animation.timingFunction.cubicOut}`};
`;
const StyledInnerIconWrapper = styled.div.withConfig({ displayName: "StyledInnerIconWrapper", componentId: "sc-1h40eto" }) `
	height: ${props => parseInt(props.theme.size.static350, 10) +
    parseInt(props.theme.size.static200, 10) *
        2}px; /* icon size plus top and bottom borders */
	width: ${props => parseInt(props.theme.size.static350, 10) +
    ...
    : props.transitionState === 'entered'
        ...
        : 'rotate(90deg)'};
`;
const StyledButton = styled.button.withConfig({ displayName: "StyledButton", componentId: "sc-vl0af8" }) `
        ...
        return (React.createElement(StyledButton, { onClick: this.handleClick, expanded: expandContent, direction: direction, ref: this.ref || undefined },
            React.createElement(StyledOverflowWrapper, { expanded: expandContent, direction: direction },
                React.createElement(StyledTextWrapper, { direction: direction, expanded: expandContent },
                    React.createElement(Text, { color: TextColor.inherit }, content))),
