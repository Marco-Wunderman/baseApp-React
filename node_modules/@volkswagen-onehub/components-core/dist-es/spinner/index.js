...
`;
const StyledSpinner = styled.svg.withConfig({ displayName: "StyledSpinner", componentId: "sc-euie9g" }) `
    ...
    css `
		...
		`}
`;
const BackgroundPath = styled.path.withConfig({ displayName: "BackgroundPath", componentId: "sc-5vs9d8" }) `
	stroke: ${props => props.theme.interaction.recipe370.disabled};
`;
const ForegroundPath = styled.path.withConfig({ displayName: "ForegroundPath", componentId: "sc-uacxr" }) `
...
export const Spinner = props => (React.createElement(StyledSpinner, { xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", fill: "none", viewBox: "0 0 24 24", variant: props.variant || 'default' },
