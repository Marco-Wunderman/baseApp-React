...
const InternalAlertLayer = props => {
    const { active, children, in: visible, onExited, role = 'alert', ariaLabel, ariaDescribedBy, scrollElementRef } = props;
    ...
    return (React.createElement(react_transition_group_1.CSSTransition, { classNames: animationClassName, onExited: onExited, in: visible, timeout: timeout },
        React.createElement(StyledLayer, { ref: scrollElementRef, role: role, "aria-label": ariaLabel, "aria-describedby": ariaDescribedBy, "aria-modal": active },
