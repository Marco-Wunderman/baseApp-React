...
export declare const FocusLayer: React.ForwardRefExoticComponent<Pick<React.PropsWithChildren<FocusLayerPropsWithAnimation>, "active" | "size" | "children" | "in" | "onExited" | "scrollElementRef" | "ariaLabelledBy"> & {
    theme?: any;
}>;
