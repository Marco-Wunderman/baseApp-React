...
const AnonymousFunctionalComponent = index_1.deprecated(() => (React.createElement("h3", null, "Anonymous")));
const AnonymousFunctionalComponentWithMessage = index_1.deprecated(() => React.createElement("h3", null, "Anonymous with custom message"), 'Anonymous with custom message is deprecated!');
function RawNamedFunctionalComponent() {
    return React.createElement("h3", null, "Named");
}
const NamedFunctionalComponent = index_1.deprecated(RawNamedFunctionalComponent);
function RawNamedFunctionalComponentWithMessage() {
    return React.createElement("h3", null, "Named with custom message");
}
const NamedFunctionalComponentWithMessage = index_1.deprecated(RawNamedFunctionalComponentWithMessage, 'Named with custom message is deprecated');
const FunctionalComponentProps = index_1.deprecated(() => React.createElement("h3", null, "Props"), ['title']);
const FunctionalComponentPropsWithMessage = index_1.deprecated(() => React.createElement("h2", null, "Props with custom messages"), [['title', 'Props with custom messages deprecated the title prop!']]);
const FunctionalComponentPropsWithMixedMessage = index_1.deprecated(() => React.createElement("h3", null, "Props with mixed messages"), [
...
NamedComponentWithMessage = __decorate([
    index_1.deprecated('Named with custom message is deprecated')
...
__decorate([
    index_1.deprecated('On class method with custom message is deprecated')
...
const HigherOrderComponent = index_1.deprecated([
    [
        'title',
...
exports.default = DeprecatedDemo;
