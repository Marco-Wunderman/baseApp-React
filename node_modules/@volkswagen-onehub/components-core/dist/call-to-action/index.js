...
const StyledLinkIcon = theme_provider_1.styled.span.withConfig({ displayName: "StyledLinkIcon", componentId: "sc-wjrax8" }) `
	border-radius: 50%;
	line-height: 0;
	position: relative;
`;
// styled component for (text-) children in links
const StyledLinkText = theme_provider_1.styled.span.withConfig({ displayName: "StyledLinkText", componentId: "sc-1phwnwt" }) `
	display: inherit;
	position: relative;
	text-decoration: none;
	padding-bottom: 2px;
...
const StyledButtonWrapper = theme_provider_1.styled.div.withConfig({ displayName: "StyledButtonWrapper", componentId: "sc-1i2uxjx" }) `
	display: grid;
...
const StyledLinkWrapper = theme_provider_1.styled.div.withConfig({ displayName: "StyledLinkWrapper", componentId: "sc-11a53hf" }) `
	display: grid;
...
const StyledButtonAsButton = theme_provider_1.styled.button.withConfig({ displayName: "StyledButtonAsButton", componentId: "sc-11eiwbg" }) `
	${buttonStyle}
`;
// styled component for large buttons (without icons, emphasis primary and secondary, that actually are links)
const StyledButtonAsLink = theme_provider_1.styled.a.withConfig({ displayName: "StyledButtonAsLink", componentId: "sc-y3e1vz" }) `
	${buttonStyle}
`;
// styled component for links (with or without icons, emphasis tertiary, that actually are buttons)
const StyledLinkAsButton = theme_provider_1.styled.button.withConfig({ displayName: "StyledLinkAsButton", componentId: "sc-5dbtv7" }) `
	${linkStyle}
`;
// styled component for links (with or without icons, emphasis tertiary, that actually are links)
const StyledLinkAsLink = theme_provider_1.styled.a.withConfig({ displayName: "StyledLinkAsLink", componentId: "sc-73dgjr" }) `
	${linkStyle}
`;
