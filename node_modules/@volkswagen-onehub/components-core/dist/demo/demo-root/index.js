...
const StyledDemoRoot = theme_provider_1.styled.div.withConfig({ displayName: "StyledDemoRoot", componentId: "sc-mddwwj" }) `
...
const StyledDemoGrid = theme_provider_1.styled.div.withConfig({ displayName: "StyledDemoGrid", componentId: "sc-k0z02s" }) `
	...
	margin: auto;
`;
const StyledDemoGridLabel = theme_provider_1.styled.label.withConfig({ displayName: "StyledDemoGridLabel", componentId: "sc-7arv9e" }) `
	position: fixed;
	bottom: 8px;
	right: 8px;
	color: black;
...
`;
const StyledDemoGridCheckbox = theme_provider_1.styled.input.withConfig({ displayName: "StyledDemoGridCheckbox", componentId: "sc-62336y" }) `
	position: fixed;
	top: 0;
	left: 0;
