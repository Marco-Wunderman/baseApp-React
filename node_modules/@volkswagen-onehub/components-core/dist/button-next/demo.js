...
const CTADemo = () => (React.createElement(demo_root_1.DemoRoot, { showGridOverlayToggle: true },
    React.createElement(demo_1.DemoThemeProviderWithToggle, null,
        React.createElement(demo_1.DemoThemeProviderToggleContext.Consumer, null, value => (React.createElement(React.Fragment, null,
            React.createElement("h2", null, "Next Button"),
            ...
            React.createElement(demo_container_1.DemoContainer, null,
                React.createElement(container_1.Container, { gutter: container_1.ContainerGutter.static200, padding: container_1.ContainerPadding.static200 },
                    React.createElement(index_1.ButtonNext, { onClick: () => undefined, emphasis: "primary", tag: "button", key: `button-1-${value.direction}`, ariaLabel: "aria label" }, "Next?"),
                    React.createElement(index_1.ButtonNext, { onClick: () => undefined, emphasis: "secondary", tag: "button", key: `button-2-${value.direction}` }, "Next?"),
                    React.createElement(index_1.ButtonNext, { onClick: () => undefined, emphasis: "primary", tag: "button", key: `button-3-${value.direction}`, size: "small" }, "Next?"),
                    React.createElement(index_1.ButtonNext, { onClick: () => undefined, emphasis: "secondary", tag: "button", key: `button-4-${value.direction}`, size: "small" }, "Next?")))))))));
