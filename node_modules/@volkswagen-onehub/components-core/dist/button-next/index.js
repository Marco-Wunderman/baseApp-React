...
const TrailingArrowRight = theme_provider_1.styled(icons_core_1.ArrowRight).withConfig({ displayName: "TrailingArrowRight", componentId: "sc-1b5br3g" }) `
	order: 1; /* move the icon from its leading position to a trailing position, without changing direction */
`;
const TrailingArrowLeft = theme_provider_1.styled(icons_core_1.ArrowLeft).withConfig({ displayName: "TrailingArrowLeft", componentId: "sc-1nuavp8" }) `
	order: 1; /* move the icon from its leading position to a trailing position, without changing direction */
`;
