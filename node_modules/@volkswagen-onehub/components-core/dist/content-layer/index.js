...
const StyledScrollWrapper = theme_provider_1.styled.div.withConfig({ displayName: "StyledScrollWrapper", componentId: "sc-10pydn7" }) `
	position: fixed;
	top: 0;
	right: 0;
	bottom: 0;
...
`;
const StyledLayer = theme_provider_1.styled.div.withConfig({ displayName: "StyledLayer", componentId: "sc-17grtnp" }) `
	height: auto;
...
function InternalContentLayer(props) {
    ...
    return (React.createElement(react_transition_group_1.CSSTransition, { classNames: animationClassName, onExited: onExited, in: visible, timeout: parseInt(props.theme.animation.duration.layer || '0', 10) },
