...
const StyledLayerWrapper = theme_provider_1.styled.div.withConfig({ displayName: "StyledLayerWrapper", componentId: "sc-1bl8kxv" }) `
	position: fixed;
	top: 0;
	right: 0;
	bottom: 0;
...
exports.LayerWrapper = props => {
    ...
    return (React.createElement(StyledLayerWrapper, { contentCentered: contentCentered },
        React.createElement(react_transition_group_1.TransitionGroup, Object.assign({}, rest, { appear: true }))));
};
