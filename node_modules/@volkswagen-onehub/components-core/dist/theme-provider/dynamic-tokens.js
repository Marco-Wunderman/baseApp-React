    ...
    return Object.keys(tokens).reduce((result, key) => {
        ...
        if (Array.isArray(currentToken)) {
            currentToken.forEach(dynamic => {
                ...
                result[dynamic.breakpoint] = Object.assign({}, result[dynamic.breakpoint], { [newPath]: dynamic.value });
            });
            return result;
        }
        if (isDynamicTokenSubtree(currentToken)) {
            ...
            Object.keys(subtreeResults).forEach(breakpoint => {
                result[breakpoint] = Object.assign({}, (result[breakpoint] || {}), subtreeResults[breakpoint]);
            });
            return result;
        }
        return result;
