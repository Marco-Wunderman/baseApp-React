...
const generateBreakpoints = (fontSize, fn) => Object.values(helpers_1.Breakpoints).reduce((acc, breakpoint) => {
    if (fontSize[breakpoint]) {
        return [
            ...acc,
            {
                breakpoint: breakpoint === helpers_1.Breakpoints.default ? breakpoint : `${breakpoint}px`,
...
exports.designTokens = {
    ...
    textTypes: {
        ...
        copy100: generateFontType(definitions_1.DesignTokenFontSizes.size100, FontStyles.Copy),
        copy150: generateFontType(definitions_1.DesignTokenFontSizes.size150, FontStyles.Copy),
        copy200: generateFontType(definitions_1.DesignTokenFontSizes.size200, FontStyles.Copy),
        copy250: generateFontType(definitions_1.DesignTokenFontSizes.size250, FontStyles.Copy),
        copy300: generateFontType(definitions_1.DesignTokenFontSizes.size300, FontStyles.Copy),
        headline200: generateFontType(definitions_1.DesignTokenFontSizes.size200, FontStyles.Headline),
        headline250: generateFontType(definitions_1.DesignTokenFontSizes.size250, FontStyles.Headline),
        headline300: generateFontType(definitions_1.DesignTokenFontSizes.size300, FontStyles.Headline),
        headline350: generateFontType(definitions_1.DesignTokenFontSizes.size350, FontStyles.Headline),
        headline400: generateFontType(definitions_1.DesignTokenFontSizes.size400, FontStyles.Headline),
        headline450: generateFontType(definitions_1.DesignTokenFontSizes.size450, FontStyles.Headline),
        headline500: generateFontType(definitions_1.DesignTokenFontSizes.size500, FontStyles.Headline),
        headline550: generateFontType(definitions_1.DesignTokenFontSizes.size550, FontStyles.Headline),
        headline600: generateFontType(definitions_1.DesignTokenFontSizes.size600, FontStyles.Headline),
        label100: generateFontType(definitions_1.DesignTokenFontSizes.size100, FontStyles.Label),
        label150: generateFontType(definitions_1.DesignTokenFontSizes.size150, FontStyles.Label),
        label200: generateFontType(definitions_1.DesignTokenFontSizes.size200, FontStyles.Label),
        label250: generateFontType(definitions_1.DesignTokenFontSizes.size250, FontStyles.Label),
        label300: generateFontType(definitions_1.DesignTokenFontSizes.size300, FontStyles.Label)
    },
    textAppearances: {
